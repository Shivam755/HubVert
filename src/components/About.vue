  ...
  <div class="container">
    ...
    <div class="carddet ">
      ...
      <div class='link'>
        ...
        <a href="https://github.com/shrutika1202" target="_blank">
        <i class="fa fa-github" style="font-size:5vw;color:#333"></i>
        </a>

        <a href="https://www.linkedin.com/in/shrutika-gholap-474977214" target="_blank">
        <i class="fa fa-linkedin" style="font-size:5vw;color:#0077b5"></i>
        </a>
        ...
        <a href="https://www.facebook.com/profile.php?id=100069147507127" target="_blank">
        <i class="fa fa-facebook" style="font-size:5vw;color:#1877f2"></i>
        </a>
      </div>
    </div>
    ...
    <div class="carddet ">
      ...
      <div class='link'>
        ...
        <a href="https://www.instagram.com/harshal_gondkar/" target="_blank">
        <i class="fa fa-instagram" style="font-size:5vw;color:#e1306c"></i>
        </a>        

        <a href="https://github.com/hrshl13" target="_blank">
        <i class="fa fa-github" style="font-size:5vw;color:#333"></i>
        </a>
